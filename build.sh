...
setup_ksu() {
	curl -kLSs "https://raw.githubusercontent.com/KernelSU-Next/KernelSU-Next/next/kernel/setup.sh" | bash -s next
...
clone() {
	...
	if [ $COMPILER == "clang" ]; then
		...
		CLANG_DIR=$KERNEL_DIR/clang/clang-r547379
